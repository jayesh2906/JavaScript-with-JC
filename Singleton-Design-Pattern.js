...
The singleton pattern is used in scenarios when we need exactly one instance of an interface (class or function).
...
singleton interface (class or function) ensures that it creates only one instance of the class, 
